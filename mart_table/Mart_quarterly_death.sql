...
CREATE OR REPLACE VIEW v_accident_sq1_process_grouped_types AS
	(SELECT
		accident_id, cause_analysis_minor_primary, accident_type_major, 
		CASE
...
CREATE OR REPLACE VIEW  v_accident_sq1_prs_grouped_types_sq1m AS
	(SELECT v.*, 
			m.accident_datetime,
